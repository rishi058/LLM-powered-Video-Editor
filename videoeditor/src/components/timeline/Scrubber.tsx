...
import { buildScrubberResizeUpdate, isTrimmableMediaType } from "~/lib/timeline/trim";
    ...
    (e: MouseEvent) => {
      ...
      if (isDragging) {
        ...
        if (resizeMode === "left") {
          ...
          const newScrubber = buildScrubberResizeUpdate({
            scrubber,
            edge: "left",
            nextLeft: newLeft,
            nextWidth: newWidth,
            pixelsPerSecond,
            minimumWidthPx: MINIMUM_WIDTH,
          });
      ...
      >
        ...
        {scrubber.mediaType !== "groupped_scrubber" && (
          <div
            ...
            title={isTrimmableMediaType(scrubber.mediaType) ? "Trim start" : "Resize left edge"}
          />
        )}
        ...
        {scrubber.mediaType !== "groupped_scrubber" && (
          <div
            ...
            title={isTrimmableMediaType(scrubber.mediaType) ? "Trim end" : "Resize right edge"}
          />
        )}
